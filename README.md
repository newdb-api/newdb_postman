...
* **`07. Формат КОНТУР (Focus)`** — полная совместимость со схемами Контур.Фокус API v3:
  ...
  - **`03. Боевой контур Production (Kontur формат)`**: 10 методов на `{{base_url}}` в формате Контур.Фокус.
